          ...
          <div className='layout-main'>
             <div className="card">
                ...
                //     onRowCollapse={onRowCollapse} 
                   ...
                   // rowExpansionTemplate={rowExpansionTemplate}
                    ...
                    <Column field="Material Number" header="Material Number" body={priceBodyTemplate}></Column>
                    <Column field="Type" header="Type"  body={priceBodyTemplate}></Column>
                    <Column field="Discription" header="Discription"  body={priceBodyTemplate}></Column>
                    <Column field="UOM" header="UOM"  body={searchBodyTemplate} />
                    <Column field="UNSPSC Description" header="  UNSPSC Description"  body={priceBodyTemplate} />
                </DataTable>
            </div>
            <div className='card'>
           <DataTable 
                  ...
                  //  expandedRows={expandedRows}
                    ...
                    <Column field="Plant" header="Plant"  body={priceBodyTemplate}></Column>
                    <Column field="Supplier Name" header="Supplier Name"  body={priceBodyTemplate}></Column>
                    <Column field="Feb22" header="Feb22"  body={priceBodyTemplate} />
                    <Column field="Mar22" header="Mar22"  body={searchBodyTemplate} />
                    <Column field="Apr22" header="Apr22"  body={priceBodyTemplate} />
                    <Column field="May22" header="May22" body={searchBodyTemplate} />
                    <Column field="Jun22" header="Jun22"  body={priceBodyTemplate} />
                    <Column field="July22" header="July22"  body={priceBodyTemplate} />
                    <Column field="Total Quantities From Supplier" header="Total Quantities From Supplier"  body={searchBodyTemplate} />
           ...
           <DataTable 
                  ...
                  //   rowExpansionTemplate={rowExpansionTemplate} 
                    ...
                    <Column field="Discription" header="Plant"  body={priceBodyTemplate}></Column>
                    <Column field="UOM" header="Name"  body={priceBodyTemplate}></Column>
                    <Column field="Feb22" header="Feb22"  body={priceBodyTemplate} />
                    <Column field="Mar22" header="Mar22"  body={searchBodyTemplate} />
                    <Column field="Apr22" header="Apr22"  body={priceBodyTemplate} />
                    <Column field="May22" header="May22" body={searchBodyTemplate} />
